...
func TestArgumentsToCliArguments(t *testing.T) {
	float32Arg := &command.ArgumentFloat32{Name: "float32Arg", Usage: "float32 argument", Default: float32(1.0)}
	float64Arg := &command.ArgumentFloat64{Name: "float64Arg", Usage: "float64 flag", Default: float64(1.0)}
	intArg := &command.ArgumentInt{Name: "intArg", Usage: "int argument", Default: 1}
	int8Arg := &command.ArgumentInt8{Name: "int8Arg", Usage: "int8 argument", Default: int8(1)}
	int16Arg := &command.ArgumentInt16{Name: "int16Arg", Usage: "int16 argument", Default: int16(1)}
	int32Arg := &command.ArgumentInt32{Name: "int32Arg", Usage: "int32 argument", Default: int32(1)}
	int64Arg := &command.ArgumentInt64{Name: "int64Arg", Usage: "int64 argument", Default: int64(1)}
	stringArg := &command.ArgumentString{Name: "stringArg", Usage: "string argument", Default: "default"}
	...
	uintArg := &command.ArgumentUint{Name: "uintArg", Usage: "uint argument", Default: uint(1)}
	uint8Arg := &command.ArgumentUint8{Name: "uint8Arg", Usage: "uint8 argument", Default: uint8(1)}
	uint16Arg := &command.ArgumentUint16{Name: "uint16Arg", Usage: "uint16 argument", Default: uint16(1)}
	uint32Arg := &command.ArgumentUint32{Name: "uint32Arg", Usage: "uint32 flag", Default: uint32(1)}
	uint64Arg := &command.ArgumentUint64{Name: "uint64Arg", Usage: "uint64 flag", Default: uint64(1)}

	float32SliceArg := &command.ArgumentFloat32Slice{Name: "float32SliceArg", Usage: "float32 slice argument", Default: []float32{2.0}}
	float64SliceArg := &command.ArgumentFloat64Slice{Name: "float64SliceArg", Usage: "float64 slice argument", Default: []float64{2.0}}
	intSliceArg := &command.ArgumentIntSlice{Name: "intSliceArg", Usage: "int slice argument", Default: []int{2}}
	int8SliceArg := &command.ArgumentInt8Slice{Name: "int8SliceArg", Usage: "int8 slice argument", Default: []int8{2}}
	int16SliceArg := &command.ArgumentInt16Slice{Name: "int16SliceArg", Usage: "int16 slice argument", Default: []int16{2}}
	int32SliceArg := &command.ArgumentInt32Slice{Name: "int32SliceArg", Usage: "int32 slice argument", Default: []int32{2}}
	int64SliceArg := &command.ArgumentInt64Slice{Name: "int64SliceArg", Usage: "int64 slice argument", Default: []int64{2}}
	stringSliceArg := &command.ArgumentStringSlice{Name: "stringSliceArg", Usage: "string slice argument", Default: []string{"b"}}
	...
	uintSliceArg := &command.ArgumentUintSlice{Name: "uintSliceArg", Usage: "uint slice argument", Default: []uint{2}}
	uint8SliceArg := &command.ArgumentUint8Slice{Name: "uint8SliceArg", Usage: "uint8 slice argument", Default: []uint8{2}}
	uint16SliceArg := &command.ArgumentUint16Slice{Name: "uint16SliceArg", Usage: "uint16 slice argument", Default: []uint16{2}}
	uint32SliceArg := &command.ArgumentUint32Slice{Name: "uint32SliceArg", Usage: "uint32 slice argument", Default: []uint32{2}}
	uint64SliceArg := &command.ArgumentUint64Slice{Name: "uint64SliceArg", Usage: "uint64 slice argument", Default: []uint64{2}}
	...
	for i, v := range arguments {
		...
		case *command.ArgumentFloat32:
			...
			assert.Equal(t, arg.GetMin(), cliArg.Min)
			assert.Equal(t, arg.GetMax(), cliArg.Max)

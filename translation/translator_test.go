...
func (t *TranslatorTestSuite) TestChoice() {
	...
	translator = NewTranslator(t.ctx, t.mockLoader, "en", "en", t.mockLog)
	t.mockLoader.On("Load", "fr", "*").Once().Return(map[string]any{}, errors.ErrLangFileNotExist)
...
func (t *TranslatorTestSuite) TestGet() {
	translator := NewTranslator(t.ctx, t.mockLoader, "en", "en", t.mockLog)
	t.mockLoader.On("Load", "en", "*").Once().Return(map[string]any{}, errors.ErrLangFileNotExist)
	t.mockLoader.On("Load", "en", "test").Once().Return(map[string]any{
		"bar": map[string]any{
			"baz": "two",
		},
	...
	translator = NewTranslator(t.ctx, t.mockLoader, "en", "en", t.mockLog)
	t.mockLoader.On("Load", "en", "*").Once().Return(map[string]any{}, errors.ErrLangFileNotExist)
	t.mockLoader.On("Load", "en", "messages").Once().Return(map[string]any{}, errors.ErrLangFileNotExist)
	...
	t.mockLoader.On("Load", "en", "*").Once().Return(map[string]any{}, errors.ErrLangFileNotExist)
	t.mockLoader.On("Load", "en", "test3").Once().Return(map[string]any{}, errors.ErrLangFileNotExist)
	t.mockLoader.On("Load", "fr", "*").Once().Return(map[string]any{}, errors.ErrLangFileNotExist)
	...
	translator = NewTranslator(t.ctx, t.mockLoader, "en", "fr", t.mockLog)
	t.mockLoader.On("Load", "en", "*").Once().Return(map[string]any{}, errors.ErrLangFileNotExist)
	t.mockLoader.On("Load", "en", "test4").Once().Return(map[string]any{}, errors.ErrLangFileNotExist)
	...
	translator = NewTranslator(t.ctx, t.mockLoader, "en", "fr", t.mockLog)
	t.mockLoader.On("Load", "en", "fallback").Once().Return(map[string]any{}, errors.ErrLangFileNotExist)
...
func (t *TranslatorTestSuite) TestLoad() {
	...
	t.mockLoader.On("Load", "es", "folder3").Once().Return(nil, errors.ErrLangFileNotExist)

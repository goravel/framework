...
func (_m *Response) Data(code int, contentType string, data []byte) error {
...
func (_m *Response) Download(filepath string, filename string) error {
...
func (_m *Response) File(filepath string) error {
...
func (_m *Response) Json(code int, obj interface{}) error {
...
func (_m *Response) Redirect(code int, location string) error {
...
func (_m *Response) String(code int, format string, values ...interface{}) error {
	var _ca []interface{}
...
func (_m *Response) View() http.ResponseView {
	ret := _m.Called()

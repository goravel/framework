...
var (
	...
	NotificationMigrationInsertionPointNotFound = New("could not find insertion point in bootstrap/migrations.go").SetModule(ModuleNotification)
	NotificationMigrationSliceCloseNotFound     = New("could not find slice closing brace in bootstrap/migrations.go").SetModule(ModuleNotification)

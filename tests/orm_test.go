...
func (s *OrmTestSuite) SetupSuite() {
	postgresTestQuery := s.postgresTestQuery()
...
func (s *OrmTestSuite) postgresTestQuery() *gorm.TestQuery1 {
	docker := postgres.NewDocker(s.database, s.username, s.password)
	...
	mockConfig.EXPECT().GetInt("database.connections.postgres.port").Return(docker.Config().Port)
	mockConfig.EXPECT().GetString("database.connections.postgres.username").Return(s.username)
	mockConfig.EXPECT().GetString("database.connections.postgres.password").Return(s.password)
	mockConfig.EXPECT().GetString("database.connections.postgres.database").Return(s.database)
	...
	driver := postgres.NewPostgres(mockConfig, utils.NewTestLog(), "postgres")
...
func (s *OrmTestSuite) TestAssociation() {
...
func (s *OrmTestSuite) TestBelongsTo() {
	for driver, query := range s.queries {
		s.Run(driver, func() {
			user := &User{
...
func (s *OrmTestSuite) TestCursor() {
	for driver, query := range s.queries {
		s.Run(driver, func() {
...
func (s *OrmTestSuite) TestEvent_Creating() {
	for _, query := range s.queries {
		tests := []struct {
			name  string
			setup func()
...
func (s *OrmTestSuite) TestEvent_Created() {
	for _, query := range s.queries {
		tests := []struct {
			name  string
			setup func()
...
func (s *OrmTestSuite) TestEvent_Saving() {
	for _, query := range s.queries {
		tests := []struct {
			name  string
			setup func()
...
func (s *OrmTestSuite) TestEvent_Saved() {
	for _, query := range s.queries {
		tests := []struct {
			name  string
			setup func()
...
func (s *OrmTestSuite) TestEvent_Updating() {
	for _, query := range s.queries {
		tests := []struct {
			name  string
			setup func()
...
func (s *OrmTestSuite) TestEvent_Updated() {
	for _, query := range s.queries {
		tests := []struct {
			name  string
			setup func()
...
func (s *OrmTestSuite) TestEvent_Deleting() {
	for _, query := range s.queries {
...
func (s *OrmTestSuite) TestEvent_Deleted() {
	for _, query := range s.queries {
...
func (s *OrmTestSuite) TestEvent_ForceDeleting() {
	for _, query := range s.queries {
...
func (s *OrmTestSuite) TestEvent_ForceDeleted() {
	for _, query := range s.queries {
...
func (s *OrmTestSuite) TestEvent_Restored() {
	for _, query := range s.queries {
...
func (s *OrmTestSuite) TestEvent_Restoring() {
	for _, query := range s.queries {
...
func (s *OrmTestSuite) TestEvent_Retrieved() {
	for _, query := range s.queries {
		tests := []struct {
			name  string
			setup func()
...
func (s *OrmTestSuite) TestEvent_IsDirty() {
	for _, query := range s.queries {
		tests := []struct {
			name  string
			setup func()
...
func (s *OrmTestSuite) TestEvent_Context() {
	for _, query := range s.queries {
...
func (s *OrmTestSuite) TestEvent_Query() {
	for _, query := range s.queries {
...
func (s *OrmTestSuite) TestExists() {
	for driver, query := range s.queries {
		s.Run(driver, func() {
...
func (s *OrmTestSuite) TestFindOrFail() {
	for _, query := range s.queries {
		tests := []struct {
			name  string
			setup func()
...
func (s *OrmTestSuite) TestFirstOr() {
	for _, query := range s.queries {
		tests := []struct {
			name  string
			setup func()
...
func (s *OrmTestSuite) TestFirstOrFail() {
	for _, query := range s.queries {
		tests := []struct {
			name  string
			setup func()
...
func (s *OrmTestSuite) TestForceDelete() {
	for _, query := range s.queries {
		tests := []struct {
			name  string
			setup func()
...
func (s *OrmTestSuite) TestLockForUpdate() {
	for driver, query := range s.queries {
...
func (s *OrmTestSuite) TestOrderBy() {
	for driver, query := range s.queries {
		s.Run(driver, func() {
...
func (s *OrmTestSuite) TestOrderByDesc() {
	for driver, query := range s.queries {
		s.Run(driver, func() {
...
func (s *OrmTestSuite) TestInRandomOrder() {
	for driver, query := range s.queries {
		s.Run(driver, func() {
			for i := 0; i < 30; i++ {
...
func (s *OrmTestSuite) TestInTransaction() {
	for driver, query := range s.queries {
		s.Run(driver, func() {
...
func (s *OrmTestSuite) TestPaginate() {
	for driver, query := range s.queries {
		s.Run(driver, func() {
...
func (s *OrmTestSuite) TestHasOne() {
	for driver, query := range s.queries {
		s.Run(driver, func() {
			user := &User{
				Name: "has_one_name",
...
func (s *OrmTestSuite) TestHasOneMorph() {
	for driver, query := range s.queries {
		s.Run(driver, func() {
			user := &User{
...
func (s *OrmTestSuite) TestHasMany() {
	for driver, query := range s.queries {
		s.Run(driver, func() {
			user := &User{
				Name: "has_many_name",
...
func (s *OrmTestSuite) TestHasManyMorph() {
	for driver, query := range s.queries {
		s.Run(driver, func() {
			user := &User{
...
func (s *OrmTestSuite) TestManyToMany() {
	for driver, query := range s.queries {
		s.Run(driver, func() {
			user := &User{
...
func (s *OrmTestSuite) TestLoadMissing() {
	for driver, query := range s.queries {
		s.Run(driver, func() {
...
func (s *OrmTestSuite) TestSaveQuietly() {
	for _, query := range s.queries {
...
func (s *OrmTestSuite) TestSharedLock() {
	for driver, query := range s.queries {
		if driver != DriverSqlite {
			s.Run(driver, func() {
...
func (s *OrmTestSuite) TestToRawSql() {
	for driver, query := range s.queries {
		s.Run(driver, func() {
			switch driver {
			case DriverPostgres:
...
func (s *OrmTestSuite) TestWhereIn() {
	for driver, query := range s.queries {
		s.Run(driver, func() {
...
func (s *OrmTestSuite) TestOrWhereIn() {
	for driver, query := range s.queries {
		s.Run(driver, func() {
			user := User{Name: "where_in_user", Avatar: "where_in_avatar"}
			s.Nil(query.Query().Create(&user))
...
func (s *OrmTestSuite) TestWhereNotIn() {
	for driver, query := range s.queries {
		s.Run(driver, func() {
			user := User{Name: "where_in_user", Avatar: "where_in_avatar"}
			s.Nil(query.Query().Create(&user))
...
func (s *OrmTestSuite) TestOrWhereNotIn() {
	for driver, query := range s.queries {
		s.Run(driver, func() {
			user := User{Name: "where_in_user", Avatar: "where_in_avatar"}
			s.Nil(query.Query().Create(&user))
...
func (s *OrmTestSuite) TestWhereBetween() {
	for driver, query := range s.queries {
		s.Run(driver, func() {
...
func (s *OrmTestSuite) TestWhereNotBetween() {
	for driver, query := range s.queries {
		s.Run(driver, func() {
...
func (s *OrmTestSuite) TestOrWhereBetween() {
	for driver, query := range s.queries {
		s.Run(driver, func() {
...
func (s *OrmTestSuite) TestOrWhereNotBetween() {
	for driver, query := range s.queries {
		s.Run(driver, func() {
			user := User{Name: "or_where_between_user", Avatar: "or_where_between_avatar"}
			s.Nil(query.Query().Create(&user))
...
func (s *OrmTestSuite) TestWhereNull() {
	for driver, query := range s.queries {
		s.Run(driver, func() {
			bio := "where_null_bio"
...
func (s *OrmTestSuite) TestOrWhereNull() {
	for driver, query := range s.queries {
		s.Run(driver, func() {
...
func (s *OrmTestSuite) TestWhereNotNull() {
	for driver, query := range s.queries {
		s.Run(driver, func() {
...
func (s *OrmTestSuite) TestWithoutEvents() {
	for _, query := range s.queries {
		tests := []struct {
			name  string
			setup func()
...
func (s *OrmTestSuite) TestWithNesting() {
	for driver, query := range s.queries {
		s.Run(driver, func() {

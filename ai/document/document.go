...
func New(content []byte, options ...frameworkai.AttachmentOption) contractsai.Attachment {
	return frameworkai.NewAttachment(contractsai.AttachmentKindFile, func(context.Context) ([]byte, string, string, error) {
...
func FromStorage(storage contractsfilesystem.Driver, path string, options ...frameworkai.AttachmentOption) contractsai.Attachment {
	return frameworkai.NewAttachment(contractsai.AttachmentKindFile, func(ctx context.Context) ([]byte, string, string, error) {

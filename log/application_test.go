...
func TestNewApplication(t *testing.T) {
	...
	mockConfig.EXPECT().GetString("logging.channels.test.formatter").Return("").Times(2) // Called for file handler and console handler when print=true
...
func TestApplication_Channel(t *testing.T) {
	...
	mockConfig.EXPECT().GetString("logging.channels.test.formatter").Return("").Times(2) // Called for file handler and console handler
	mockConfig.EXPECT().GetBool("logging.channels.test.print").Return(true).Once()
	...
	mockConfig.EXPECT().GetString("logging.channels.dummy.formatter").Return("").Times(2) // Called for file handler and console handler

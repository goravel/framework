...
func TestEventMakeCommand(t *testing.T) {
	...
	assert.True(t, file.Contain("app/events/goravel_broadcast_event.go", "func (receiver *GoravelBroadcastEvent) BroadcastOn() []broadcasting.Channel {"))
	...
	assert.True(t, file.Contain("app/events/goravel_broadcast_event_now.go", "func (receiver *GoravelBroadcastEventNow) BroadcastOn() []broadcasting.Channel {"))

...
func (s *ModifyActionsTestSuite) Test_appendToExistingMigration() {
	tests := []struct {
		name              string
		initialContent    string
...
func (s *ModifyActionsTestSuite) Test_addMigrationImports() {
	tests := []struct {
		name             string
		initialContent   string
		pkg              string
...
func (s *ModifyActionsTestSuite) Test_foundationSetupMigration() {
	tests := []struct {
		name           string
		initialContent string
		migrationToAdd string
...
func (s *ModifyActionsTestSuite) Test_checkWithCommandsExists() {
	tests := []struct {
		name     string
		content  string
		expected bool
...
func (s *ModifyActionsTestSuite) Test_createCommandsFile() {
	tests := []struct {
		name            string
		expectedContent string
	}{
...
func (s *ModifyActionsTestSuite) Test_addCommandToCommandsFile() {
	tests := []struct {
		name            string
		initialContent  string
		pkg             string
...
func (s *ModifyActionsTestSuite) Test_addCommandImports() {
	tests := []struct {
		name            string
		initialContent  string
		pkg             string
...
func (s *ModifyActionsTestSuite) Test_foundationSetupCommandInline() {
	tests := []struct {
		name            string
		initialContent  string
		commandToAdd    string
...
func (s *ModifyActionsTestSuite) Test_foundationSetupCommandWithFunction() {
	tests := []struct {
		name            string
		initialContent  string
		expectedContent string
...
func (s *ModifyActionsTestSuite) Test_appendToExistingCommand() {
	tests := []struct {
		name              string
		initialContent    string
		commandToAdd      string
...
func (s *ModifyActionsTestSuite) Test_createWithCommands() {
	tests := []struct {
		name           string
		initialContent string
		commandToAdd   string
...
func (s *ModifyActionsTestSuite) Test_findFoundationSetupCallsForCommand() {
	tests := []struct {
		name                 string
		initialContent       string
		expectSetup          bool

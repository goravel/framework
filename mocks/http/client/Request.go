...
// Timeout provides a mock function with given fields: duration
func (_m *Request) Timeout(duration time.Duration) client.Request {
...
// Request_Timeout_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Timeout'
type Request_Timeout_Call struct {
	*mock.Call
}

// Timeout is a helper method to define mock.On call
//   - duration time.Duration
func (_e *Request_Expecter) Timeout(duration interface{}) *Request_Timeout_Call {
	return &Request_Timeout_Call{Call: _e.mock.On("Timeout", duration)}
}

func (_c *Request_Timeout_Call) Run(run func(duration time.Duration)) *Request_Timeout_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Request_Timeout_Call) Return(_a0 client.Request) *Request_Timeout_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Request_Timeout_Call) RunAndReturn(run func(time.Duration) client.Request) *Request_Timeout_Call {
	_c.Call.Return(run)
	return _c
}

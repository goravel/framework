...
func (_m *ResponseView) First(views []string, data ...interface{}) error {
	var _ca []interface{}
...
func (_c *ResponseView_First_Call) Return(_a0 error) *ResponseView_First_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ResponseView_First_Call) RunAndReturn(run func([]string, ...interface{}) error) *ResponseView_First_Call {
	_c.Call.Return(run)
	return _c
}

// Make provides a mock function with given fields: view, data
func (_m *ResponseView) Make(view string, data ...interface{}) error {
	var _ca []interface{}
	_ca = append(_ca, view)
	_ca = append(_ca, data...)
	ret := _m.Called(_ca...)
...
func (_c *ResponseView_Make_Call) Return(_a0 error) *ResponseView_Make_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ResponseView_Make_Call) RunAndReturn(run func(string, ...interface{}) error) *ResponseView_Make_Call {
	_c.Call.Return(run)
	return _c
}

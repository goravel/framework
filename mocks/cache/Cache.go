...
func (_c *Cache_Decrement_Call) Run(run func(key string, value ...int)) *Cache_Decrement_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Cache_Decrement_Call) Return(_a0 int, _a1 error) *Cache_Decrement_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Cache_Decrement_Call) RunAndReturn(run func(string, ...int) (int, error)) *Cache_Decrement_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *Cache_Increment_Call) Run(run func(key string, value ...int)) *Cache_Increment_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]int, len(args)-1)
		for i, a := range args[1:] {
			if a != nil {
...
func (_c *Cache_Increment_Call) Return(_a0 int, _a1 error) *Cache_Increment_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Cache_Increment_Call) RunAndReturn(run func(string, ...int) (int, error)) *Cache_Increment_Call {
	_c.Call.Return(run)
	return _c
}

...
func (_m *Body) Build() (io.Reader, error) {
	ret := _m.Called()
...
func (_c *Body_Build_Call) Return(_a0 io.Reader, _a1 error) *Body_Build_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Body_Build_Call) RunAndReturn(run func() (io.Reader, error)) *Body_Build_Call {
	_c.Call.Return(run)
	return _c
}

...
func (_m *OnPipeOutputFunc) Execute(typ process.OutputType, key string, line []byte) {
...
//   - key string
//   - line []byte
func (_e *OnPipeOutputFunc_Expecter) Execute(typ interface{}, key interface{}, line interface{}) *OnPipeOutputFunc_Execute_Call {
	return &OnPipeOutputFunc_Execute_Call{Call: _e.mock.On("Execute", typ, key, line)}
}

func (_c *OnPipeOutputFunc_Execute_Call) Run(run func(typ process.OutputType, key string, line []byte)) *OnPipeOutputFunc_Execute_Call {
...
func (_c *OnPipeOutputFunc_Execute_Call) RunAndReturn(run func(process.OutputType, string, []byte)) *OnPipeOutputFunc_Execute_Call {
	_c.Run(run)
	return _c
}

...
func (_m *OnPoolOutputFunc) Execute(key string, typ process.OutputType, line []byte) {
...
//   - line []byte
func (_e *OnPoolOutputFunc_Expecter) Execute(key interface{}, typ interface{}, line interface{}) *OnPoolOutputFunc_Execute_Call {
	return &OnPoolOutputFunc_Execute_Call{Call: _e.mock.On("Execute", key, typ, line)}
}

func (_c *OnPoolOutputFunc_Execute_Call) Run(run func(key string, typ process.OutputType, line []byte)) *OnPoolOutputFunc_Execute_Call {
...
func (_c *OnPoolOutputFunc_Execute_Call) RunAndReturn(run func(string, process.OutputType, []byte)) *OnPoolOutputFunc_Execute_Call {
	_c.Run(run)
	return _c
}

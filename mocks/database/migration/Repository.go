...
func (_m *Repository) RepositoryExists() {
	_m.Called()
}
...
func (_c *Repository_RepositoryExists_Call) Return() *Repository_RepositoryExists_Call {
	_c.Call.Return()
	return _c
}

func (_c *Repository_RepositoryExists_Call) RunAndReturn(run func()) *Repository_RepositoryExists_Call {
	_c.Call.Return(run)
	return _c
}

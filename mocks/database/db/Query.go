...
func (_m *Query) Each(callback func(*sqlx.Rows) error) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(func(*sqlx.Rows) error) error); ok {
		r0 = rf(callback)
	} else {
		r0 = ret.Error(0)
	}
...
//   - callback func(*sqlx.Rows) error
func (_e *Query_Expecter) Each(callback interface{}) *Query_Each_Call {
	return &Query_Each_Call{Call: _e.mock.On("Each", callback)}
}

func (_c *Query_Each_Call) Run(run func(callback func(*sqlx.Rows) error)) *Query_Each_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(func(*sqlx.Rows) error))
	})
	return _c
}
...
func (_c *Query_Each_Call) RunAndReturn(run func(func(*sqlx.Rows) error) error) *Query_Each_Call {
	_c.Call.Return(run)
	return _c
}

...
func (_m *Builder) Queryx(query string, args ...interface{}) (*sqlx.Rows, error) {
	var _ca []interface{}
	_ca = append(_ca, query)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
...
// Builder_Queryx_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Queryx'
type Builder_Queryx_Call struct {
	*mock.Call
}
...
//   - query string
//   - args ...interface{}
func (_e *Builder_Expecter) Queryx(query interface{}, args ...interface{}) *Builder_Queryx_Call {
	return &Builder_Queryx_Call{Call: _e.mock.On("Queryx",
		append([]interface{}{query}, args...)...)}
}

func (_c *Builder_Queryx_Call) Run(run func(query string, args ...interface{})) *Builder_Queryx_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]interface{}, len(args)-1)
		for i, a := range args[1:] {
			if a != nil {
...
func (_c *Builder_Queryx_Call) Return(_a0 *sqlx.Rows, _a1 error) *Builder_Queryx_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Builder_Queryx_Call) RunAndReturn(run func(string, ...interface{}) (*sqlx.Rows, error)) *Builder_Queryx_Call {
	_c.Call.Return(run)
	return _c
}

...
func (_m *Grammar) TypePatternMapping() []driver.TypePatternMapping {
	ret := _m.Called()
...
// Grammar_TypePatternMapping_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'TypePatternMapping'
type Grammar_TypePatternMapping_Call struct {
	*mock.Call
}

// TypePatternMapping is a helper method to define mock.On call
func (_e *Grammar_Expecter) TypePatternMapping() *Grammar_TypePatternMapping_Call {
	return &Grammar_TypePatternMapping_Call{Call: _e.mock.On("TypePatternMapping")}
}

func (_c *Grammar_TypePatternMapping_Call) Run(run func()) *Grammar_TypePatternMapping_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *Grammar_TypePatternMapping_Call) Return(_a0 []driver.TypePatternMapping) *Grammar_TypePatternMapping_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Grammar_TypePatternMapping_Call) RunAndReturn(run func() []driver.TypePatternMapping) *Grammar_TypePatternMapping_Call {
	_c.Call.Return(run)
	return _c
}

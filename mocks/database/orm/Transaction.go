...
func (_m *Transaction) WhereHas(relation string, callback func(orm.Query) (orm.Query, error), args ...interface{}) orm.Query {
	var _ca []interface{}
...
// Transaction_WhereHas_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'WhereHas'
type Transaction_WhereHas_Call struct {
	*mock.Call
}
...
//   - args ...interface{}
func (_e *Transaction_Expecter) WhereHas(relation interface{}, callback interface{}, args ...interface{}) *Transaction_WhereHas_Call {
	return &Transaction_WhereHas_Call{Call: _e.mock.On("WhereHas",
		append([]interface{}{relation, callback}, args...)...)}
}

func (_c *Transaction_WhereHas_Call) Run(run func(relation string, callback func(orm.Query) (orm.Query, error), args ...interface{})) *Transaction_WhereHas_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]interface{}, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *Transaction_WhereHas_Call) Return(_a0 orm.Query) *Transaction_WhereHas_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Transaction_WhereHas_Call) RunAndReturn(run func(string, func(orm.Query) (orm.Query, error), ...interface{}) orm.Query) *Transaction_WhereHas_Call {
	_c.Call.Return(run)
	return _c
}

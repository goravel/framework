...
// Put provides a mock function with given fields: options
func (_m *Attachment) Put(options ...ai.Option) (ai.StoredFileResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(...ai.Option) (ai.StoredFileResponse, error)); ok {
		return rf(options...)
	}
	if rf, ok := ret.Get(0).(func(...ai.Option) ai.StoredFileResponse); ok {
		r0 = rf(options...)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(...ai.Option) error); ok {
		r1 = rf(options...)
	} else {
		r1 = ret.Error(1)
	}
...
//   - options ...ai.Option
func (_e *Attachment_Expecter) Put(options ...interface{}) *Attachment_Put_Call {
	return &Attachment_Put_Call{Call: _e.mock.On("Put",
		append([]interface{}{}, options...)...)}
}

func (_c *Attachment_Put_Call) Run(run func(options ...ai.Option)) *Attachment_Put_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]ai.Option, len(args)-0)
...
func (_c *Attachment_Put_Call) RunAndReturn(run func(...ai.Option) (ai.StoredFileResponse, error)) *Attachment_Put_Call {
	_c.Call.Return(run)
	return _c
}

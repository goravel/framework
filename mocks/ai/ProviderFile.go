...
func (_m *ProviderFile) Put(ctx context.Context, options ...ai.Option) (ai.StoredFileResponse, error) {
	_va := make([]interface{}, len(options))
	for _i := range options {
		_va[_i] = options[_i]
	}
...
func (_c *ProviderFile_Put_Call) Return(_a0 ai.StoredFileResponse, _a1 error) *ProviderFile_Put_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ProviderFile_Put_Call) RunAndReturn(run func(context.Context, ...ai.Option) (ai.StoredFileResponse, error)) *ProviderFile_Put_Call {
	_c.Call.Return(run)
	return _c
}

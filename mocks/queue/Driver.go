...
// Driver_Clear_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Clear'
type Driver_Clear_Call struct {
	*mock.Call
}

// Clear is a helper method to define mock.On call
//   - _a0 string
func (_e *Driver_Expecter) Clear(_a0 interface{}) *Driver_Clear_Call {
	return &Driver_Clear_Call{Call: _e.mock.On("Clear", _a0)}
}

func (_c *Driver_Clear_Call) Run(run func(_a0 string)) *Driver_Clear_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *Driver_Clear_Call) Return(_a0 error) *Driver_Clear_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Driver_Clear_Call) RunAndReturn(run func(string) error) *Driver_Clear_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - _a0 string
//   - job queue.Jobs
func (_e *Driver_Expecter) Delete(_a0 interface{}, job interface{}) *Driver_Delete_Call {
	return &Driver_Delete_Call{Call: _e.mock.On("Delete", _a0, job)}
}

func (_c *Driver_Delete_Call) Run(run func(_a0 string, job queue.Jobs)) *Driver_Delete_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(queue.Jobs))
	})
	return _c
}
...
func (_c *Driver_Delete_Call) RunAndReturn(run func(string, queue.Jobs) error) *Driver_Delete_Call {
	_c.Call.Return(run)
	return _c
}
...
// Driver_Release_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Release'
type Driver_Release_Call struct {
	*mock.Call
}
...
//   - job queue.Jobs
//   - delay uint
func (_e *Driver_Expecter) Release(_a0 interface{}, job interface{}, delay interface{}) *Driver_Release_Call {
	return &Driver_Release_Call{Call: _e.mock.On("Release", _a0, job, delay)}
}

func (_c *Driver_Release_Call) Run(run func(_a0 string, job queue.Jobs, delay uint)) *Driver_Release_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(queue.Jobs), args[2].(uint))
	})
	return _c
}

func (_c *Driver_Release_Call) Return(_a0 error) *Driver_Release_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Driver_Release_Call) RunAndReturn(run func(string, queue.Jobs, uint) error) *Driver_Release_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - _a0 string
func (_e *Driver_Expecter) Size(_a0 interface{}) *Driver_Size_Call {
	return &Driver_Size_Call{Call: _e.mock.On("Size", _a0)}
}

func (_c *Driver_Size_Call) Run(run func(_a0 string)) *Driver_Size_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *Driver_Size_Call) Return(_a0 uint64, _a1 error) *Driver_Size_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Driver_Size_Call) RunAndReturn(run func(string) (uint64, error)) *Driver_Size_Call {
	_c.Call.Return(run)
	return _c
}

...
func (_m *Option) Execute(_a0 *validation.Options) {
	_m.Called(_a0)
}
...
//   - _a0 *validation.Options
func (_e *Option_Expecter) Execute(_a0 interface{}) *Option_Execute_Call {
	return &Option_Execute_Call{Call: _e.mock.On("Execute", _a0)}
}

func (_c *Option_Execute_Call) Run(run func(_a0 *validation.Options)) *Option_Execute_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*validation.Options))
	})
	return _c
}
...
func (_c *Option_Execute_Call) RunAndReturn(run func(*validation.Options)) *Option_Execute_Call {
	_c.Run(run)
	return _c
}

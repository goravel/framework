...
func (_m *Setup) Install(modifiers ...modify.GoFile) packages.Setup {
	...
	if rf, ok := ret.Get(0).(func(...modify.GoFile) packages.Setup); ok {
		r0 = rf(modifiers...)
	} else {
		if ret.Get(0) != nil {
...
func (_c *Setup_Install_Call) Run(run func(modifiers ...modify.GoFile)) *Setup_Install_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]modify.GoFile, len(args)-0)
		for i, a := range args[0:] {
			if a != nil {
				variadicArgs[i] = a.(modify.GoFile)
			}
		}
		run(variadicArgs...)
	})
...
func (_c *Setup_Install_Call) RunAndReturn(run func(...modify.GoFile) packages.Setup) *Setup_Install_Call {
	_c.Call.Return(run)
	return _c
}

// Uninstall provides a mock function with given fields: modifiers
func (_m *Setup) Uninstall(modifiers ...modify.GoFile) packages.Setup {
	_va := make([]interface{}, len(modifiers))
	for _i := range modifiers {
		_va[_i] = modifiers[_i]
	}
...
func (_c *Setup_Uninstall_Call) Run(run func(modifiers ...modify.GoFile)) *Setup_Uninstall_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]modify.GoFile, len(args)-0)
		for i, a := range args[0:] {
			if a != nil {
...
func (_c *Setup_Uninstall_Call) RunAndReturn(run func(...modify.GoFile) packages.Setup) *Setup_Uninstall_Call {
	_c.Call.Return(run)
	return _c
}

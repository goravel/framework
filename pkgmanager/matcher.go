...
type (
	...
	MatchGoNodes []pkgmanager.GoNodeMatcher
)
...
func MatchAnyNode() pkgmanager.GoNodeMatcher {
	return &MatchGoNode{
		match: func(node dst.Node) bool {
			return true
		},
...
func MatchArrayType(elt, l pkgmanager.GoNodeMatcher) pkgmanager.GoNodeMatcher {
	return MatchGoNode{
...
func MatchBasicLit(value string) pkgmanager.GoNodeMatcher {
	return MatchGoNode{
		match: func(n dst.Node) bool {
...
func MatchCallExpr(fun pkgmanager.GoNodeMatcher, args MatchGoNodes) pkgmanager.GoNodeMatcher {
	return MatchGoNode{
		match: func(n dst.Node) bool {
...
func MatchCompositeLit(t pkgmanager.GoNodeMatcher) pkgmanager.GoNodeMatcher {
	return MatchGoNode{
		match: func(n dst.Node) bool {
...
func MatchEqualNode(n dst.Node) pkgmanager.GoNodeMatcher {
	return MatchGoNode{
		match: func(node dst.Node) bool {
...
func MatchEqualStatement(statement string) pkgmanager.GoNodeMatcher {
	return MatchGoNode{
		match: func(node dst.Node) bool {
...
func MatchFuncDecl(name pkgmanager.GoNodeMatcher) pkgmanager.GoNodeMatcher {
	return MatchGoNode{
		match: func(n dst.Node) bool {
...
func MatchIdent(name string) pkgmanager.GoNodeMatcher {
	return MatchGoNode{
		match: func(n dst.Node) bool {
...
func MatchImportSpec(path string, name ...string) pkgmanager.GoNodeMatcher {
	return MatchGoNode{
		match: func(n dst.Node) bool {
...
func MatchKeyValueExpr(key, value pkgmanager.GoNodeMatcher) pkgmanager.GoNodeMatcher {
	return MatchGoNode{
		match: func(n dst.Node) bool {
...
func MatchLastOf(n pkgmanager.GoNodeMatcher) pkgmanager.GoNodeMatcher {
	return MatchGoNode{
		last:  true,
		match: n.MatchNode,
	}
...
func MatchSelectorExpr(x, sel pkgmanager.GoNodeMatcher) pkgmanager.GoNodeMatcher {
	return MatchGoNode{
		match: func(n dst.Node) bool {
...
func MatchTypeOf[T any](_ T) pkgmanager.GoNodeMatcher {
	return MatchGoNode{
		match: func(node dst.Node) bool {
			_, ok := node.(T)
			return ok

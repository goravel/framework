...
var providerMatchers = []pkgmanager.GoNodeMatcher{
...
func AddConfigSpec(path, name, statement string) pkgmanager.GoNodeModifier {
	return ModifyGoNode{
...
func AddImportSpec(path string, name ...string) pkgmanager.GoNodeModifier {
	return ModifyGoNode{
		Matchers: []pkgmanager.GoNodeMatcher{
...
func AddProviderSpec(statement string) pkgmanager.GoNodeModifier {
...
func AddProviderSpecAfter(statement, after string) pkgmanager.GoNodeModifier {
	return providerSpecInsertTo(
...
func AddProviderSpecBefore(statement, before string) pkgmanager.GoNodeModifier {
	return providerSpecInsertTo(
...
func RemoveConfigSpec(path string) pkgmanager.GoNodeModifier {
	return ModifyGoNode{
		Matchers: buildConfigMatchers(strings.Split(path, ".")),
		Action: func(cursor *dstutil.Cursor) {
			cursor.Delete()
...
func RemoveImportSpec(path string, name ...string) pkgmanager.GoNodeModifier {
	return ModifyGoNode{
		Matchers: []pkgmanager.GoNodeMatcher{
...
func RemoveProviderSpec(statement string) pkgmanager.GoNodeModifier {
	return ModifyGoNode{
...
func ReplaceConfigSpec(path, statement string) pkgmanager.GoNodeModifier {
	return ModifyGoNode{
		Matchers: buildConfigMatchers(strings.Split(path, ".")),
		Action: func(cursor *dstutil.Cursor) {
...
func buildConfigMatchers(keys []string) []pkgmanager.GoNodeMatcher {
	var matchers = []pkgmanager.GoNodeMatcher{
		MatchFuncDecl(MatchIdent("init")),
		MatchCallExpr(
			MatchSelectorExpr(
				MatchIdent("config"),
...
func providerSpecInsertTo(matchers []pkgmanager.GoNodeMatcher, statement string, before bool) pkgmanager.GoNodeModifier {
	return ModifyGoNode{
		Matchers: matchers,
		Action: func(cursor *dstutil.Cursor) {
